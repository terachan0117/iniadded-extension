...
function showSettings() {
    ...
    containerFluidContents += '<div class="media"><div class="media-left"><a href="https://iniadded.tera-chan.com/" target="_blank"><img class="media-object" src="https://iniadded.tera-chan.com/img/icon128.png" alt="INIADded" style="width:73px;height:73px;"></a></div><div class="media-body"><h4 class="media-heading">INIADded Extension (Version ' + APP_VERSION + ')</h4>' +
        ...
        '<a class="btn btn-default btn-sm" href="https://iniadded.tera-chan.com/#extension" target="_blank"><i class="fa fa-question-circle"></i> 使い方 How to use</a>' +
    ...
    if (localStorage.getItem("HideName")) {
        containerFluidContents += '<div class="form-group row"><label class="col-sm-3 col-form-label">名前非表示<br>Hide Name</label><div class="col-sm-9"><input id="SlideSmall" type="checkbox" name="SlideSmall"></div></div>';
    } else {
